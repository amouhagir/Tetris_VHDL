...
set_property PACKAGE_PIN E16 [get_ports BUT_ROTATE]						
	set_property IOSTANDARD LVCMOS33 [get_ports BUT_ROTATE]
#Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
set_property PACKAGE_PIN F15 [get_ports BUT_PAUSE]						
	set_property IOSTANDARD LVCMOS33 [get_ports BUT_PAUSE]
...
set_property PACKAGE_PIN V10 [get_ports BUT_DOWN]						
